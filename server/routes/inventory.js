...
router.get("/logs", requireAuth, requirePermission("inventory:read"), (req, res) => {
...
router.post("/logs", requireAuth, requirePermission("inventory:write"), (req, res) => {
  const now = new Date().toISOString();
...
router.delete("/logs", requireAuth, requirePermission("inventory:write"), (req, res) => {
...
router.delete("/:id", requireAuth, requirePermission("inventory:write"), (req, res) => {
  const now = new Date().toISOString();
...
router.delete("/", requireAuth, requirePermission("inventory:write"), (req, res) => {
